        ...
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <!-- Form Tambah kuisioner-->
               <form role="form" action="proses tambah kuesioner.php" method="post" name="postform" enctype="multipart/form-data">
               <h4><center>Tambah Pertanyaan</center></h4>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="idkuesioner" class="mdl-textfield__label">Id Kuisioner</label>
                   <input type="text" pattern="[K0-9]*" class="mdl-textfield__input" id="idkuesioner" name="idkuesioner" />
