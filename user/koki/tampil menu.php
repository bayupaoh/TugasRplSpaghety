      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
			<h4><center>Kelola Menu</center></h4>
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <center>
            <!-- tabel koki -->
            <table class="mdl-data-table mdl-js-data-table">
              <thead>
                <tr>
                  <th class="mdl-data-table__cell--non-numeric">Id Menu</th>
...
?>
                <tr>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row["id_menu"];?></td>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row["nama_menu"];?></td>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row["harga"];?></td>
<td><a id="detail<?php echo $row['id_menu'];?>" class="mdl-button mdl-js-button mdl-button--icon" href="detail menu.php?id=<?php echo $row['id_menu'];?>"><em class="mdi mdi-food-variant"></em> </a>
                    <div class="mdl-tooltip" for="detail<?php echo $row['id_menu'];?>">
                    Detail
                    </div>
<a id="ubah<?php echo $row['id_menu'];?>" class="mdl-button mdl-js-button mdl-button--icon" href="edit menu.php?id=<?php echo $row['id_menu'];?>"><em class="mdi mdi-tooltip-edit"></em> </a>
                    <div class="mdl-tooltip" for="ubah<?php echo $row['id_menu'];?>">
                    Ubah
                    </div>
                  						<a id="hapus<?php echo $row['id_menu'];?>" class="mdl-button mdl-js-button mdl-button--icon" href="proses hapus menu.php?id=<?php echo $row['id_menu'];?>">
                  						  <i class="mdi mdi-delete"></i>
                  						</a>
                  						<div class="mdl-tooltip" for="hapus<?php echo $row['id_menu'];?>">
                  							Hapus
                  						</div>
</td>
</tr>
<?php } ?>
		...
		<a href="tambah menu.php" id="view-source">
