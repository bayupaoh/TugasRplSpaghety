      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <!-- Form edit kategori-->
               <form role="form" action="proses edit kategori.php" method="post" name="postform" enctype="multipart/form-data">
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="idjabatan" class="mdl-textfield__label">Id Kategori</label>
                   <input type="text" pattern="[K0-9]*" class="mdl-textfield__input" id="idkategori" name="idkategori" value="<?php echo $id_kategori;?>" readonly/>
                   <span class="mdl-textfield__error">Format : KXXX</span>
               </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="namakategori" class="mdl-textfield__label">Nama Kategori</label>
                   <input type="text" pattern="[A-Z a-z]*" class="mdl-textfield__input" id="namakategori" name="namakategori" value="<?php echo $namakategori;?>"/>
                   <span class="mdl-textfield__error">Tidak boleh berupa angka atau simbol</span>
               </div>
               <br>
               <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent " type="submit">Edit Kategori</button>
