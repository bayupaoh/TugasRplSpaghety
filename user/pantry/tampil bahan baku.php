    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--primary mdl-color--white mdl-color-text--white-600">
        ...
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Tampil Bahan Baku</span>
        ...
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            ...
            <table class="mdl-data-table mdl-js-data-table">
              <thead>
                <tr>
                  <th class="mdl-data-table__cell--non-numeric">Id Bahan</th>
                  <th class="mdl-data-table__cell--non-numeric">Nama</th>
                  <th class="mdl-data-table__cell--non-numeric">Stok</th>
                  <th class="mdl-data-table__cell--non-numeric">Stok min</th>
			  ...
			  ?>
                <tr>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row['id_bahanbaku'];?></td>
                  ...
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row['stok_minimum'];?></td>
                  <td>
                              <a id="detail" class="mdl-button mdl-js-button mdl-button--icon" href="detail bahan baku.php?id=<?php echo $row['id_bahanbaku'];?>">
                              <i class="mdi mdi-account-circle"></i>
                              </a>
                              <div class="mdl-tooltip" for="detail">
                               Detail Bahan Baku
                              </div>
                  						<a id="edit" class="mdl-button mdl-js-button mdl-button--icon" href="edit bahan baku.php?id=<?php echo $row['id_bahanbaku'];?>">
                  						  <i class="mdi mdi-tooltip-edit"></i>
                  						</a>
                  						<div class="mdl-tooltip" for="edit">
                  							Edit Bahan Baku
                  						</div>
                  						<a id="hapus" class="mdl-button mdl-js-button mdl-button--icon" href="proses hapus bahan baku.php?id=<?php echo $row['id_bahanbaku'];?>">
