...
<?php
	...
	$foto = $_SESSION['foto'];
	$idbahan = $_GET['id'];
	$query = "SELECT * FROM bahanbaku WHERE id_bahanbaku = '$idbahan'";
    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--primary mdl-color--white mdl-color-text--white-600">
        ...
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Edit Bahan Baku</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <!-- Form Tambah Jabatan-->
               <form role="form" action="proses edit bahan baku.php?id=<?php echo $idpegawai;?>" method="post" name="postform" enctype="multipart/form-data">
               <h4>Form Edit Bahan Baku</h4>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="idbahanbaku" class="mdl-textfield__label">Id Bahan</label>
                   <input type="text" pattern="[B0-9]*" class="mdl-textfield__input" id="idbahanbaku" name="idbahanbaku" value="<?php echo $idbahan;?>" readonly/>
                   <span class="mdl-textfield__error">Format : BXXX</span>
               </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="namabahanbaku" class="mdl-textfield__label">Nama bahan baku</label>
                   <input type="text" pattern="[A-Z a-z]*" class="mdl-textfield__input" id="namabahanbaku" name="namabahanbaku" value="<?php echo $namabahan;?>"/>
               ...
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   ...
                   <input type="text" pattern="[A-Za-z]*" class="mdl-textfield__input" id="satuanbahanbaku" name="satuanbahanbaku" value="<?php echo $satuan;?>"/>
                   <span class="mdl-textfield__error">Tidak boleh berupa angka atau simbol</span>
               </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="stokbahanbaku" class="mdl-textfield__label">stok bahan baku</label>
                   <input type="text" pattern="[0-9]*" class="mdl-textfield__input" id="stokbahanbaku" name="stokbahanbaku" value="<?php echo $stok;?>"/>
               ...
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   ...
                   <input type="text" pattern="[0-9]*" class="mdl-textfield__input" id="stokminbahanbaku" name="stokminbahanbaku" value="<?php echo $stok_min;?>"/>
                   <span class="mdl-textfield__error">Tidak boleh berupa huruf atau simbol</span>
               </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label ">
                  <label >Tanggal Masuk</label>
                  <input type="date" class="mdl-textfield__input" id="tanggalmasuk" name="tanggalmasuk" value="<?php echo $tglmasuk;?>"/>
              </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label ">
                  <label >Tanggal Kadaluarsa</label>
                  <input type="date" class="mdl-textfield__input" id="tanggalkadaluarsa" name="tanggalkadaluarsa" value="<?php echo $tglkadaluarsa;?>"/>
              </div>
               <br>
               <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent " type="submit">Edit Bahan Baku</button>
