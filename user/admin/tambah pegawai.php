    ...
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
      <header class="demo-header mdl-layout__header mdl-color--primary mdl-color--white mdl-color-text--white-600">
        ...
        <div class="mdl-layout__header-row">
          <span class="mdl-layout-title">Kelola Pegawai</span>
      ...
      <main class="mdl-layout__content mdl-color--grey-100">
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            <!-- Form Tambah Pegawai-->
               <form role="form" action="proses tambah pegawai.php" method="post" name="postform" enctype="multipart/form-data">
               <h4>Form Tambah Pegawai</h4>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   <label for="nip" class="mdl-textfield__label">NIP</label>
                   <input type="text" pattern="[PJ0-9]*" class="mdl-textfield__input" id="nip" name="nip" />
               ...
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   ...
                   <input type="text" pattern="[A-Za-z]*" class="mdl-textfield__input" id="tempatlahir" name="tempatlahir" />
                   <span class="mdl-textfield__error">Tidak boleh berupa angka atau simbol</span>
               </div>
               ...
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                   ...
                   <textarea class="mdl-textfield__input" id="alamat" name="alamat" ></textarea>
               </div>
               <br>
               <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
               ...
               <button class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent " type="submit">Tambah Pegawai</button>
