...
<html lang="en">
  ...
  <body>
    <div class="demo-layout mdl-layout mdl-js-layout mdl-layout--fixed-drawer mdl-layout--fixed-header">
        ...
        <div class="mdl-grid demo-content">
          <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
            ...
            <table class="mdl-data-table mdl-js-data-table">
              <thead>
                <tr>
                  <th class="mdl-data-table__cell--non-numeric">Id Jabatan</th>
                  <th class="mdl-data-table__cell--non-numeric">Nama Jabatan</th>
                  <th class="mdl-data-table__cell--non-numeric">Gaji</th>
			  ...
			  ?>
                <tr>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row['id_jabatan'];?></td>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row['nama_jabatan'];?></td>
                  <td class="mdl-data-table__cell--non-numeric"><?php echo $row['gaji'];?></td>
                  <td>
                  						<a id="edit" class="mdl-button mdl-js-button mdl-button--icon" href="edit jabatan.php?id=<?php echo $row['id_jabatan'];?>">
                  						  <i class="mdi mdi-tooltip-edit"></i>
                  						</a>
                  						<div class="mdl-tooltip" for="edit">
                  							Edit Jabatan
                  						</div>
                  						<a id="hapus" class="mdl-button mdl-js-button mdl-button--icon" href="proses hapus jabatan.php?id=<?php echo $row['id_jabatan'];?>">
      ...
      <a href="tambah jabatan.php" id="view-source">
